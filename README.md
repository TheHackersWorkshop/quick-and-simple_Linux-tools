...
- **[Find.py](Find.py)** – Search for files using wildcards. See [Find.read](Find.read) for usage.
...
- **[Dd.sh](Dd.sh)** – Easy dd command control. See [dd.read](dd.read) for usage.
- **[dump.py](dump.py)** – TCPDump data with menu options. See [dump.read](dump.read) for usage.
...
- **[add_ip.sh](add_ip.sh)** – Add IP addresses to hosts file. See [add_ip.read](add_ip.read) for usage.
